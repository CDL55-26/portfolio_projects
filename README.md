...
| [Wireless blood pressure sensor](./wireless_bp_sensor) | nrf-controlled PLL synthesizer + power log detector + custom antenna. Used to wirelessly track changes in pressure of LC tank based off magnetic coupling.| ADF4351, ADL5920, Zephyr RTOS, KiCad|
